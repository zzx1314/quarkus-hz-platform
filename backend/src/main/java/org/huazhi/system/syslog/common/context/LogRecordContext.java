package org.huazhi.system.syslog.common.context;
...
public class LogRecordContext {
    ...
    public static Object getMethodOrGlobal(String key) {
        ...
        Map<String, Object> variableMap = (stack != null && !stack.isEmpty()) ? stack.peek() : null;

        if (variableMap != null && !variableMap.isEmpty()) {
            result = variableMap.get(key);
            if (result != null) {
                return result;
            }
        }
