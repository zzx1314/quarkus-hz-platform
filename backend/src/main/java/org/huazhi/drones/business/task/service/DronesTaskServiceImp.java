...
import org.huazhi.drones.business.command.commanditem.service.DronesCommandResultItemService;
...
import org.huazhi.drones.business.workflow.entity.NodeEntityData;
            ...
            if (!resultItem.isEmpty()) {
                for (DronesCommandResultItem item : resultItem) {
                    ...
                    if (state != null && state) {
                        ...
                        String errorInfo = commandResult.path("actionResult").path("msg").asText();
